/* vibescale-ignore-file CONSOLE_DEBUG */

// This file tests suppression directives

// vibescale-ignore-next-line TEMPORARY_HACK
// TODO: This should be suppressed
const placeholder = "test";

const data = await fetch("/api/data"); // vibescale-ignore-line UNSAFE_IO
...
// vibescale-ignore-next-line UNBOUNDED_QUERY,LOOPED_IO
